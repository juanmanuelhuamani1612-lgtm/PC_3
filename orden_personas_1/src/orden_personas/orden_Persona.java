...
public class orden_Persona {
    ...
    private static int partitionPorPeso(Persona[] personas, int low, int high) {
        // Elegir el pivote (peso de la persona en la posición high)
        double pivot = personas[high].peso;
        int i = low - 1;
